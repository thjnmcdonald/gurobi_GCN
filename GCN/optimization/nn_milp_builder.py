...
def build_GCN_milp_and_run_bt(model: gpy.Model, input_vars, output_vars, state_dict, n, d_max, c_id=0, bt_procedures=None, bilinear = False, norm_term = None, multilayer = False):
    ...
    # bounds = [[(-10, 10) for i in range(14)],
    #         [(-10, 10) for i in range(32)]]
    ...
    if multilayer == False:
        GCN_milp_builder_1(model, input_vars, output_vars, weights, n, hidden_bounds, c_id = 'GCN', bilinear = bilinear, norm_term = norm_term)
    else:
        GCN_milp_builder_3(model, input_vars, output_vars, weights, n, hidden_bounds, c_id = 'GCN', bilinear = bilinear, norm_term = norm_term)
