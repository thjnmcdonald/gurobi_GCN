...
def GCN_milp_builder_3(model: gpy.Model, input_vars, output_vars, weights, n, hidden_bounds=None, c_id=0, bilinear = False, norm_term = None, A = None):
    """
    Builds a MILP model of a neural network with ReLU activations.
